...
|---|---|---|
| [2026-09-25](2026-09-25.md) | 24-entry radar: Sep-25 Mojo 1.2/MAX 26.7 nightly; comptime control-flow consolidation; annotations proposal; audio/DSP, bioinformatics, numerics, regex, FFI/networking, LDPC and physics discoveries | region-scoped arm64 Span CPU-time diagnostic; pointer cursor; AffineGaps oracle; comptime regex; MMMAudio DSP |
| [2026-09-24](2026-09-24.md) | 20-entry broad radar: TOML/CSV/config parsing, ZIP/storage, SDL/Raylib/physics, scientific ML, visualization/rendering and mixed-language algorithm discoveries; no unchanged official release filler | arm64 Span CPU-time diagnostic; CSV SIMD tokenizer; canvas parallel crossover; TOML stage decomposition; ZIP stored-entry boundary |
| [2026-09-23](2026-09-23.md) | 24-entry radar: Sep-23 Mojo 1.2/MAX 26.7 nightly; top-k tail correctness; HLCF `elif` preservation; DeepSeek-V4 paged sparse cache; media, rendering, VM, interop, serialization and ML discoveries | arm64 scanner CPU-affinity diagnostic; serializer call-path replication; TRELLIS stage oracle; FFmpeg ABI boundary; BVH crossover |
| [2026-09-22](2026-09-22.md) | 24-entry radar: Sep-22 Mojo 1.2/MAX 26.7 nightly; `TileTensor` dynamic slicing; media observability; DP scheduling fixes; quantum, numerics, FFI, benchmarking, education, compression and compiler/tooling discoveries | Category-D pointer-cursor intervention; `TileTensor` slice differential; `bench.mojo` calibration; QLabs gate benchmark; zlib CRC32 oracle/codegen |
